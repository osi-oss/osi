...
// Временные заглушки для экранов которые еще не созданы
const TempCompleteProfileScreen = () => (
  <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
    <Text>Complete Profile Screen (будет реализован)</Text>
  </View>
);

const TempOrganizationsScreen = () => (
  <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
    <Text>Organizations Screen (будет реализован)</Text>
  </View>
);
      ...
      >
        {!isAuthenticated ? (
          ...
          <Stack.Screen
            ...
            component={TempCompleteProfileScreen}
            options={{ title: 'Заполнение профиля' }}
          />
        ) : (
          <Stack.Screen
            name="Organizations"
            component={TempOrganizationsScreen}
